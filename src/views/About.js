      ...
      <Container maxWidth="md">
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} sm={6}>
            <Typography variant="body1" paragraph>
              Hoodline was founded in 2010 by two passionate pizza enthusiasts, John Doe and Jane Smith. With a shared love for culinary arts and a
              vision to create the perfect pizza, they embarked on a journey to bring their dream to life. Located in the heart of the city, Hoodline
        ...
        <Grid container spacing={4} sx={{ mt: 4 }}>
          <Grid item xs={12} sm={6}>
            ...
            <BackgroundText variant="body1" paragraph>
          ...
          <Grid item xs={12} sm={6}>
            <img src={restaurant} alt="Hoodline Interior" style={{ width: '100%', borderRadius: '8px' }} />
          </Grid>
        </Grid>
        <Grid container spacing={4} sx={{ mt: 4 }}>
          <Grid item xs={12} sm={6}>
